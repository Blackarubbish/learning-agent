...
eval_data = {
    ...
    "reference": [
        "深度学习是机器学习的一个分支，由 Hinton 等人在 2006 年提出...",
        "Hinton 等人在 2006 年提出了深度学习概念...",
    ],
}
...
testset_generator = generate_testset(
    llm=ChatOpenAI(model="gpt-4o-mini"), embedding_model=OpenAIEmbeddings()
)

# 生成 50 个测试问题
testset = testset_generator.generate(documents=documents, num_samples=50, raise_errors=False)
